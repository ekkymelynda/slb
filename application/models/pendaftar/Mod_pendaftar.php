  <?php class Mod_pendaftar extends CI_Model {
...
//$acak = rand(1,1);
      $data = array (
        ...
        'PENDAFTAR_NAMA' => $pendaftar['pendaftar_nama'],
        'PENDAFTAR_STATUS' => $pendaftar['pendaftar_status'],
        'PENDAFTAR_ALAMAT' => $pendaftar['pendaftar_rumah'],
        'PENDAFTAR_TELP' => $pendaftar['pendaftar_telepon'],
        'SW_NAMA' => $pendaftar['siswa_nama'],
        'SW_NAMAPANGGIL' => $pendaftar['siswa_namapanggilan'],
        'SW_TEMPATLAHIR' => $pendaftar['siswa_tempat_lahir'],
        'SW_TGLLAHIR' => $pendaftar['siswa_tanggal_lahir'],
        'SW_USIAPERMASUK' =>$pendaftar['siswa_usia'],
        'SW_JK' => $pendaftar['jenis_kelamin'],
            //tabel agama
        'AG_ID' => $pendaftar['siswa_agama'],
            //tabel warganegara
        'KWN_ID' => $pendaftar['siswa_warganegara'],
            //tabel jenis_tinggal
        //'JT_ID' => $pendaftar['siswa_tinggal'],
        'JT_ID' => '1',
        'AT_ID' => '1',
        'SW_BAHASARUMAH' => $pendaftar['siswa_bahasa'],
        'SW_ANAKKE' => $pendaftar['siswa_anakke'],
        'SW_JMLBERSDR' => $pendaftar['siswa_anakke_dari'],
        'SW_TINGKATASALSEKOLAH' => $pendaftar['siswa_sekolahasal'],
        'SW_ASALSEKTHNMASUK' => $pendaftar['siswa_masuktahun'],
        'SW_ASALSEKTHNLULUS' => $pendaftar['siswa_lulus'],
       // 'SW_ALAMATASALSEK' => $pendaftar['siswa_alamat_sekolah'],
       // 'SW_AKTIVSUKA' => $pendaftar['siswa_aktifitas'],
        'SW_LAMAKANDUNGANBLN' => $pendaftar['siswa_lama_kandungan_bulan'],
        'SW_LAMAKANDUNGANHARI' => $pendaftar['siswa_lama_kandungan_hari'],

        'SW_KEADAANKANDUNGAN' => $pendaftar['siswa_keadaan_kandungan'],
        'SW_KEADAANLAHIR' => $pendaftar['siswa_keadaan_lahir'],

        'SW_PROSESLAHIR' => $pendaftar['siswa_proses_kelahiran'],
        'SW_YGMEMBANTULAHIR' => $pendaftar['siswa_membantu_kelahiran'],
        'SW_BERATLAHIR' => $pendaftar['siswa_berat_lahir'],
        'SW_PANJANGLAHIR' => $pendaftar['siswa_panjang_lahir'],
        'SW_USIAIBUSAATLAHIR' => $pendaftar['siswa_usiaibu_lahir'],
        //'SW_BERATANAK' => $pendaftar['siswa_berat'],
        //'SW_PANJANGANAK' => $pendaftar['siswa_tinggi'],
        //'SW_GOLDAR' => $pendaftar['siswa_golongan'],
        //'SW_LAMAMINUMASI' => $pendaftar['siswa_asi'],
        //'SW_DUABLNAWAL' => $pendaftar['siswa_perkembangan'],
            //tabel kelainantubuh
            //$siswa_kelainan,

        //'SW_MAKANANTAMBAHAN' => $pendaftar['siswa_makanan_4bln'],
            //tabel imunisasi
            //$siswa_imunisasi,

        //'SW_ALERGI' => $pendaftar['siswa_alergi'],
        //'SW_PENGLIHATAN' => $pendaftar['siswa_penglihatan'],
       // 'SW_PENDENGARAN' => $pendaftar['siswa_pendengaran'],
        //'SW_PENAMPILAN' => $pendaftar['siswa_penampilan'],
            //masukkan ke tabel saudara_kandung
            //$saudara_anak,

            //yg inin bener
        //'SW_CIRIFISIK' => $pendaftar['siswa_ciri'],
            //masukkan ke dalam tabel ciri_kepribadian
            //$siswa_kepribadian,

       // 'SW_BAKATKHUSUS' => $pendaftr['siswa_bakat'],
       // 'SW_PRESTASI' => $pendaftar['siswa_prestasi'],
