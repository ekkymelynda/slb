    ...
    <section id="feature" class="transparent-bg">
    	...
    	<div class="container">
           	<div class="center wow fadeInDown">
                <h2>Buat Data Indikator Keberhasilan</h2>
           	</div>
            <!-- Row -->
           	<div class="row">
				<form role="form" method="post" action= "<?php  echo site_url('Master/Ik/create_data');?>">
		            <div class="col-lg-6">
		            	<div class="form-group">
                            <label>Masukkan Id Indikator Keberhasilan</label>
                            <input type="number" class="form-control" placeholder="Contoh: 1" name="INDI_ID" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <textarea type="text" class="form-control" placeholder="Contoh: Sepeda Motor" name="INDI_KET"></textarea>
                        </div>
