    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
            <div class="center wow fadeInDown">
                <div class="center wow fadeInDown">
                    <h2>Tabel Agama</h2>
                    <a align="text-right" href="<?php  echo site_url('Create/agama');?>" class="btn btn-success btn-lg" role="button" style="float: right;">Buat Agama</a></span>
                </div>
                <div class="table-responsive">
                    <table id="mytable" class="table table-hover">
                        ...
                        <tbody>
                                ...
                                <td class="text-left"><?php echo $d['AG_ID'] ?></td>
                                <td class="text-left"><?php echo $d['AG_NAMA'] ?></td></td>
