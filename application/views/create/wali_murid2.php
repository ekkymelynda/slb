                            ...
                            <form role="form" action="create_data" method="post" class="registration-form">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <div class="form-group">
                                            <!-- <label class="sr-only" for="form-first-name">First name</label> -->
                                            <input type="text" name="WM_TGLLAHIR" placeholder="Tanggal Lahir" class="form-control">
                                        </div>
                                        <div class="form-group">
                                            <!-- <label class="sr-only" for="form-first-name">First name</label> -->
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-bottom">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="WM_JMLTANGGUNG" placeholder="Jumlah Tanggungan" class="form-control">
                                        </div>
