...
class Pendaftar extends CI_Controller
{
    ...
    {
        $data = $this->Crud->GetPendaftar();
        $this->load->view('header')->view('read/pendaftar', array('data' => $data))->view('footer');
    }
...
//
    ...
    {
        $temp = $this->Crud->GetPendaftar(" where SW_ID = '$SW_ID'");
        $data = array(
            'SW_ID' => $temp[0]['SW_ID'],
        ...
        $this->load->view('header')->view('update/pendaftar', $data)->view('footer');
    }
    ...
    public function view_detail($SW_ID)
    {
        ...
        $this->load->view('header')->view('detail/pendaftar', $data)->view('footer');
    }
}