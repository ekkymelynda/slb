...
<body>
    ...
    <section id="feature" class="transparent-bg">
    	...
    	<div class="container">
          ...
          <div class="row">
            <div class="col-lg-3">
              <span class="glyphicon glyphicon-user" style="font-size:225px; color:#d43133"></span>
            </div>
            <div class="col-lg-8">
              <form class="form-horizontal" role="form" method="post" action= "">
                <div class="col-lg-15">
                  <div class="form-group">
                    <label class="col-sm-3 control-label">Rombel</label>
                    <div class="col-sm-9">
                  ...
                  <div class="form-group">
                    <label class="col-sm-3 control-label">SKHUN</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">Penerima KPS</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-3 control-label">No. KPS</label>
                    <div class="col-sm-9">
                      <input type="text" class="form-control" value="">
                    </div>
                  </div>
