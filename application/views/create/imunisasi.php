    ...
    <section id="feature" class="transparent-bg">
    	...
    	<div class="container">
           	<div class="center wow fadeInDown">
                <h2>Buat Data Imunisasi</h2>
           	</div>
            <!-- Row -->
           	<div class="row">
				<form role="form" method="post" action= "<?php  echo site_url('Master/Imunisasi/create_data');?>">
		            <div class="col-lg-6">
		            	<!-- <div class="form-group">
                            <label>Masukkan Id Imunisasi</label>
                            <input type="number" class="form-control" placeholder="Contoh: 1" name="IM_ID" >
                        </div> -->
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" placeholder="Contoh: 1" name="IM_JENIS" >
                        </div>
                        <div class="form-group">
                            <label>Masukkan Usia Imunisasi</label>
                            <input type="text" class="form-control" placeholder="Contoh: 1" name="IM_USIA" >
                        </div>
