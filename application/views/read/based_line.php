    ...
    <section id="feature" class="transparent-bg">
        <div class="container">
            <div class="center wow fadeInDown">
                <div class="center wow fadeInDown">
                    <h2>Tabel Based Line</h2>
                    <a align="text-right" href="<?php  echo site_url('Create/based_line');?>" class="btn btn-success btn-lg" role="button" style="float: right;">Buat Based Line</a></span>
                </div>
                    ...
                    <table id="mytable" class="table table-hover">
                       <thead>
                        ...
                        <tbody>
                                ...
                                <td class="text-left"><?php echo $d['BASELINE_ID'] ?></td>
                                <td class="text-left"><?php echo $d['PLK_ID'] ?></td>
                                <td class="text-left"><?php echo $d['BASELINE_KET'] ?></td>
